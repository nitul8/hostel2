                ...
                <div className="max-w-4xl mx-auto rounded-lg p-6">
                    <section className="mb-8">
                        ...
                        <p className="text-justify text-md text-white">
                            ...
                            Institute, Sri H.N. Barua also as the Principal
                            in-charge of Jorhat Engineering College.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-justify text-md text-white">
                            ...
                            significant contributions to the world. It is a
                            center brimming with new talents, innovative
                            thinkers, and vibrant, passionate individuals.
                        </p>
                        ...
                        <p className="text-justify text-md text-white">
                            ...
                            unique chapter in one's journey, where the mundane
                            meets the extraordinary, and where every day unfolds
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-justify text-md text-white mb-4">
                            ...
                            cherished haven for countless travelers, students,
                            and wanderers. This hostel, though modest in its
                        ...
                        <p className="text-justify text-md text-white mb-4">
                            ...
                            supervision of various Superintendents like Sri.
                        ...
                        <p className="text-justify text-md text-white">
                            ...
                            1. Prof Himandra Nath Borthakur was the hostel
                            superintendent, and Bhaba Chetia was the monitor.
                            The teaching staff initially comprised of Debajit
                            Chaliha (Electrical Engineering), Sashi Sarma
                            (Mechanical Engineering), Hemen Borthakur (Civil
                            Engineering), SD Phukan (Civil Engineering),
                            Nirupoma Buragohain (Mathematics), Hamidur Rahman
                            (Physics), and Kamruz Zaman.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <ul className="list-disc list-inside pl-4 mb-4 space-y-2 text-white">
                            ...
                            <li>
                                2nd Position in Cleaning Competitions in 2023
                            </li>
                            <li>And many more...</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-justify text-md text-white mb-4">
                            ...
                            heartfelt occasion that brought together
                            generations, each carrying their own memories and
                            stories. The joy evident in the faces of the
